...
public class PacoteService extends AbstractFacade<Pacote> {
    ...
    public void create(Pacote entity) {
        super.create(entity);
    }
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, Pacote entity) {
        super.edit(entity);
    }
    ...
    public Pacote find(@PathParam("id") Integer id) {
    ...
    @Path("{from}/{to}")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<Pacote> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
